...
public class Book extends TableImpl<BookRecord> {
    ...
    /**
     * The column <code>public.book.created_date_time</code>.
     */
    public final TableField<BookRecord, LocalDateTime> CREATED_DATE_TIME = createField(DSL.name("created_date_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.book.updated_date_time</code>.
     */
    public final TableField<BookRecord, LocalDateTime> UPDATED_DATE_TIME = createField(DSL.name("updated_date_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    public AuthorBookPath authorBook() {
        if (_authorBook == null)
            _authorBook = new AuthorBookPath(this, null, Keys.AUTHOR_BOOK__FK_AUTHOR_BOOK_BOOK.getInverseKey());
