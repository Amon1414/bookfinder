...
import com.example.db.tables.AuthorBook.AuthorBookPath;
...
public class Author extends TableImpl<AuthorRecord> {
     ...
     */
    public final TableField<AuthorRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR.nullable(false), this, "");
    ...
    /**
     * The column <code>public.author.created_date_time</code>.
     */
    public final TableField<AuthorRecord, LocalDateTime> CREATED_DATE_TIME = createField(DSL.name("created_date_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.author.updated_date_time</code>.
     */
    public final TableField<AuthorRecord, LocalDateTime> UPDATED_DATE_TIME = createField(DSL.name("updated_date_time"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    private transient AuthorBookPath _authorBook;

    /**
     * Get the implicit to-many join path to the <code>public.author_book</code>
     * table
     */
    public AuthorBookPath authorBook() {
        if (_authorBook == null)
            _authorBook = new AuthorBookPath(this, null, Keys.AUTHOR_BOOK__FK_AUTHOR_BOOK_AUTHOR.getInverseKey());
